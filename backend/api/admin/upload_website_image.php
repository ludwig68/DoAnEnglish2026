...
$uploadDir = dirname(__DIR__, 2) . '/uploads/website-images';
...
$fileName = 'website_' . date('Ymd_His') . '_' . bin2hex(random_bytes(4)) . '.' . $extension;
...
$projectBasePath = preg_replace('#/backend/api/admin/upload_website_image\.php$#', '', $scriptName);
$publicUrl = $scheme . '://' . $host . $projectBasePath . '/backend/uploads/website-images/' . $fileName;
