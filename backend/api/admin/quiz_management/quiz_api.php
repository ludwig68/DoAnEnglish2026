...
// Moved to standard API location: backend/api/admin/quiz_management/quiz_api.php
// require paths updated accordingly (3 levels up instead of 2)
...
const QUIZ_CATEGORIES = ['summary', 'grammar', 'vocabulary', 'reading', 'listening', 'speaking', 'writing'];
